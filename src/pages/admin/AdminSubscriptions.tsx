...
import { adminStats, mockPlans } from '@/lib/mock-data';
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border bg-card p-5">
            ...
            <p className="mt-1 text-2xl font-bold">
              {adminStats.activePlans.professional}
            </p>
          </div>
          <div className="rounded-xl border bg-card p-5">
            <p className="text-sm text-muted-foreground">Premium Subscribers</p>
            <p className="mt-1 text-2xl font-bold">
              {adminStats.activePlans.premium}
            </p>
          </div>
        </div>
        ...
        <PlanFormModal
          ...
          onSave={(data) => {
            toast({
              title: editingPlan ? 'Plan Updated' : 'Plan Added',
              description: `${data.name} — features saved as: ${data.featuresRaw}`,
            });
          }}
        />
      </div>
