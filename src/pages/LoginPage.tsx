...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      await login('demo@google.com', '', role);
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            disabled={isLoading}
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-lg border bg-card px-4 py-2.5 text-sm font-medium transition-colors hover:bg-muted disabled:opacity-50"
          >
